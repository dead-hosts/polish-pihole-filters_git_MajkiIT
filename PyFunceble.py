...
class Settings(object):  # pylint: disable=too-few-public-methods
    ...
    travis_autosave_final_commit = "[Results] Test of polish-pihole-filters"
    # Default travis commit message
    travis_autosave_commit = "[Autosave] Test of polish-pihole-filters"
    ...
    # Current directory.
    current_dir = '/home/travis/build/dead-hosts/polish-pihole-filters_git_MajkiIT/'
